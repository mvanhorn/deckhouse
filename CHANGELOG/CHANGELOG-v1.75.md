...
## Features
 ...
 - **[cert-manager]** Add alerts for ACME Challenges stuck in pending or error states [#18669](https://github.com/deckhouse/deckhouse/pull/18669)
 ...
 - **[cloud-provider-azure]** add NVMe disk discovery support for Ubuntu 22.04 Gen2 VMs [#19159](https://github.com/deckhouse/deckhouse/pull/19159)
 ...
 - **[istio]** Allow custom ports in metadataEndpoint URLs for IstioFederation and IstioMulticluster CRDs. [#19320](https://github.com/deckhouse/deckhouse/pull/19320)
 ...
 - **[terraform-manager]** Suppress destructive changes when add/remove/change labels and annotations for cloud resources via opentofu. [#19080](https://github.com/deckhouse/deckhouse/pull/19080)
    These changes prevent unnecessary or destructive plan updates that could occur when data sources depend on changing labels and annotations. The behavior of other cloud providers is not affected.
    If you encounter unexpected converge plans or cluster bootstrap issues when using OpenTofu-based providers (such as dvp, dynamics, zvirt, or yandex), please report them to Deckhouse Technical Support.
...
## Fixes
 ...
 - **[admission-policy-engine]** Fix high resource consumption for constraint d8denyexecheritage [#19099](https://github.com/deckhouse/deckhouse/pull/19099)
 ...
 - **[cloud-provider-azure]** fix CVE in cloud-provider-azure [#18177](https://github.com/deckhouse/deckhouse/pull/18177)
 ...
 - **[cloud-provider-dvp]** Suppress destructive changes when add/remove/change labels and annotations for cloud resources via opentofu. [#19080](https://github.com/deckhouse/deckhouse/pull/19080)
 - **[cloud-provider-dvp]** allow user to use additionalDisks in master InstanceClass [#18361](https://github.com/deckhouse/deckhouse/pull/18361)
 ...
 - **[cloud-provider-gcp]** fix CVEs in cloud-provider-gcp [#18328](https://github.com/deckhouse/deckhouse/pull/18328)
 ...
 - **[cloud-provider-huaweicloud]** fix CVEs in cloud-provider-huaweicloud [#18179](https://github.com/deckhouse/deckhouse/pull/18179)
 ...
 - **[cloud-provider-openstack]** Increase interval and timeout for health monitor [#19350](https://github.com/deckhouse/deckhouse/pull/19350)
 - **[cloud-provider-openstack]** fix CVE in cloud-provider-openstack module [#18180](https://github.com/deckhouse/deckhouse/pull/18180)
 ...
 - **[cloud-provider-vcd]** Fix LogrAdapter panic in VCD infra-controller-manager [#20147](https://github.com/deckhouse/deckhouse/pull/20147)
 ...
 - **[cloud-provider-vcd]** fix CVE in cloud-provider-vcd module [#18327](https://github.com/deckhouse/deckhouse/pull/18327)
 - **[cloud-provider-vcd]** fix cve [#17136](https://github.com/deckhouse/deckhouse/pull/17136)
 - **[cloud-provider-vcd]** fix vCD CCM TCP health monitors removal [#19283](https://github.com/deckhouse/deckhouse/pull/19283)
 - **[cloud-provider-vsphere]** Fix maping for kubernetes data disk [#17859](https://github.com/deckhouse/deckhouse/pull/17859)
 - **[cloud-provider-vsphere]** Fix vSphere privilege matrix and describe instructions for setting up environment via vSphere Client [#18848](https://github.com/deckhouse/deckhouse/pull/18848)
 ...
 - **[cni-cilium]** Fixed CVE-2026-33186, CVE-2026-27142, and CVE-2026-27139 by updating grpc dependency and Go version, and resolved build compatibility issues. [#18645](https://github.com/deckhouse/deckhouse/pull/18645)
 ...
 - **[cni-cilium]** Updated go-jose dependency to v4.1.4 to fix CVE-2026-34986. [#19010](https://github.com/deckhouse/deckhouse/pull/19010)
    Cilium agents will be restarted during the update.
 - **[cni-flannel]** Fixed CVE-2026-33186 by updating google.golang.org/grpc in flanneld. [#19103](https://github.com/deckhouse/deckhouse/pull/19103)
    This update triggers a rolling update of the flannel pods.
 - **[cni-flannel]** Reverted module stage from Deprecated back to General Availability to stop false deprecation alerts. [#20306](https://github.com/deckhouse/deckhouse/pull/20306)
 - **[cni-simple-bridge]** Refactored python image source and pip exclusion. [#19144](https://github.com/deckhouse/deckhouse/pull/19144)
 ...
 - **[common]** fixed CVE-2026-29181 in the CoreDNS [#20259](https://github.com/deckhouse/deckhouse/pull/20259)
 ...
 - **[control-plane-manager]** Upgraded etcd to 3.6.7. [#17492](https://github.com/deckhouse/deckhouse/pull/17492)
    etcd will restart.
 - **[csi-vsphere]** Fixed the Deckhouse queue getting stuck [#20146](https://github.com/deckhouse/deckhouse/pull/20146)
 ...
 - **[deckhouse-controller]** added extra validation for kubernets version multiple downgrades scenario [#18934](https://github.com/deckhouse/deckhouse/pull/18934)
 ...
 - **[dhctl]** Fix deadlock in converge. [#18564](https://github.com/deckhouse/deckhouse/pull/18564)
 ...
 - **[dhctl]** Fix restart bootstrap during creating additional nodes in cloud permanent node groups. [#18565](https://github.com/deckhouse/deckhouse/pull/18565)
 ...
 - **[dhctl]** Skip tmp lock for exporter and auto-converger. [#18780](https://github.com/deckhouse/deckhouse/pull/18780)
 ...
 - **[dhctl]** Use internal node ip if bastion ip was passed in converge. [#19094](https://github.com/deckhouse/deckhouse/pull/19094)
 - **[dhctl]** Wait for stronghold cluster sync before node deletion [#19797](https://github.com/deckhouse/deckhouse/pull/19797)
 - **[dhctl]** dhctl must not skip namespace update on cluster bootstrap, if namespace already exists [#19195](https://github.com/deckhouse/deckhouse/pull/19195)
 ...
 - **[dhctl]** mitigate CVE-2026-33186 [#18644](https://github.com/deckhouse/deckhouse/pull/18644)
 ...
 - **[docs]** Fix vSphere privilege matrix and describe instructions for setting up environment via vSphere Client [#18848](https://github.com/deckhouse/deckhouse/pull/18848)
 ...
 - **[extended-monitoring]** fix typo in image-availability-exporter template [#18597](https://github.com/deckhouse/deckhouse/pull/18597)
 ...
 - **[ingress-nginx]** Added fix for CVE-2026-4342. [#18930](https://github.com/deckhouse/deckhouse/pull/18930)
 ...
 - **[ingress-nginx]** CVE-2025-15566 is fixed in 1.10 and 1.12 controllers. [#19261](https://github.com/deckhouse/deckhouse/pull/19261)
 ...
 - **[istio]** fixed CVE-2026-33186 in v1.25.2 images [#18797](https://github.com/deckhouse/deckhouse/pull/18797)
    pods in namespace d8-istio will be restarted
 - **[istio]** fixed CVE-2026-34986 [#19018](https://github.com/deckhouse/deckhouse/pull/19018)
    istio module pods will be restarted
 - **[istio]** fixed CVE-2026-39882, CVE-2026-39883 and CVE-2026-35206 [#19311](https://github.com/deckhouse/deckhouse/pull/19311)
    istio module pods will be restarted
 - **[istio]** fixed CVEs in module images [#19424](https://github.com/deckhouse/deckhouse/pull/19424)
    module pods will be restarted
 - **[istio]** fixed discovery_operator_versions_to_install.go hook to migrate from 1.21 to 1.25 [#19646](https://github.com/deckhouse/deckhouse/pull/19646)
 ...
 - **[network-gateway]** Updated dnsmasq to v2.92-alt2 to address multiple security vulnerabilities (CVE-2026-*) [#19934](https://github.com/deckhouse/deckhouse/pull/19934)
 - **[network-gateway]** Updated python image source and mitigated pip CVE-2026-1703 [#19146](https://github.com/deckhouse/deckhouse/pull/19146)
 - **[network-policy-engine]** Fixed CVE-2026-34040, CVE-2026-33997, and CVE-2026-33186 in network-policy-engine dependencies. [#19105](https://github.com/deckhouse/deckhouse/pull/19105)
    This update triggers a rolling update of the network-policy-engine pods.
 ...
 - **[node-manager]** Added cleanup for oversized MCM MachineSet revision history annotation [#19654](https://github.com/deckhouse/deckhouse/pull/19654)
 ...
 - **[node-manager]** CAPI crd served version fix [#19679](https://github.com/deckhouse/deckhouse/pull/19679)
 ...
 - **[node-manager]** optimize node-controller cache resources usage. [#19225](https://github.com/deckhouse/deckhouse/pull/19225)
 ...
 - **[node-manager]** rollback inject capi conversion hook in crds as on-before-helm [#19229](https://github.com/deckhouse/deckhouse/pull/19229)
...
## Chore
 ...
 - **[cilium-hubble]** Fixed vex file [#19009](https://github.com/deckhouse/deckhouse/pull/19009)
 ...
 - **[cni-cilium]** Added vex with CVE-2026-33726 for hubble [#18917](https://github.com/deckhouse/deckhouse/pull/18917)
 ...
 - **[cni-cilium]** Fixed vex file [#19009](https://github.com/deckhouse/deckhouse/pull/19009)
 - **[cni-cilium]** Refactor build to use pre-packaged dependencies from envoyproxy_deps repository instead of downloading from GitHub at build time [#18937](https://github.com/deckhouse/deckhouse/pull/18937)
 ...
 - **[ingress-nginx]** Added unconfined seccomp profile to Ingress-NGINX controller pods. [#18929](https://github.com/deckhouse/deckhouse/pull/18929)
    All Ingress-NGINX controller pods will be restarted.
 ...
 - **[istio]** vex justified CVE-2026-42151 and CVE-2026-42154 in pilot and operator images [#20189](https://github.com/deckhouse/deckhouse/pull/20189)
 ...
 - **[monitoring-custom]** Add clarification to D8ReservedNodeLabelOrTaintFound alert description. [#19296](https://github.com/deckhouse/deckhouse/pull/19296)
